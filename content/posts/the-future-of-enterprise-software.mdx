...
The story arc is familiar but worth revisiting.
...
Everyone's talking about how AI will replace the humans who use enterprise software. This misses the more profound shift: the objects themselves are becoming autonomous.

The invoice isn't just a record anymore. It *wants* to get approved. It *wants* to get paid. The opportunity doesn't just sit in a database—it actively pursues its own closure.
...
This transition from passive records to autonomous objects fundamentally changes how we think about enterprise software:
...
- CoPlane's autonomous AP and AR objects are reimagining financial operations, turning static invoices and payments into goal-seeking entities that optimize working capital across supply chains
